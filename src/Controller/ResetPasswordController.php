...
class ResetPasswordController extends AbstractController
{
    ...
    #[Route('/processSending', name: 'app_userm_', methods: ['GET', 'POST'])]
    private function processSendingPasswordResetEmailm(string $emailFormData, MailerInterface $mailer, TranslatorInterface $translator,NormalizerInterface $Normalizer): RedirectResponse
    {
        $user = $this->entityManager->getRepository(User::class)->findOneBy([
            'email' => $emailFormData,
        ]);
        ...
        $jsonContent = $Normalizer->normalize($user.$email,$resetToken, 'json', ['groups' => 'user']);
