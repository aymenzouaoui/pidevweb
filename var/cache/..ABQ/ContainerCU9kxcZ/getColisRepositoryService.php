 ...
 */
class getColisRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ColisRepository' shared autowired service.
     *
     * @return \App\Repository\ColisRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ColisRepository.php';

        return $container->privates['App\\Repository\\ColisRepository'] = new \App\Repository\ColisRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
