...
return [
    ...
    'app_competition_edit' => [['id'], ['_controller' => 'App\\Controller\\CompetitionController::editComp'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/competition/edit/b']], [], [], []],
    'app_competition_delete' => [['id'], ['_controller' => 'App\\Controller\\CompetitionController::delete'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/competition']], [], [], []],
    'deleteCompetitionJSON' => [['id'], ['_controller' => 'App\\Controller\\CompetitionController::deleteCompJSON'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/competition/deleteCompetitionJSON']], [], [], []],
    ...
    'app_map' => [['id'], ['_controller' => 'App\\Controller\\MapController::index'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/map']], [], [], []],
    ...
    'app_json_newRes' => [[], ['_controller' => 'App\\Controller\\ReservationController::add'], [], [['text', '/reservation/newJson']], [], [], []],
    ...
    'app_userm_' => [[], ['_controller' => 'App\\Controller\\ResetPasswordController::processSendingPasswordResetEmailm'], [], [['text', '/reset-password/processSending']], [], [], []],
    ...
    'app_annonces_json_all' => [[], ['_controller' => 'App\\Controller\\SerializerController::allAnnonces'], [], [['text', '/Json/allAnnonces']], [], [], []],
    'app_annonces_json' => [['id'], ['_controller' => 'App\\Controller\\SerializerController::AnnonceID'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/Json/allAnnonces']], [], [], []],
    'app_jsona_new' => [[], ['_controller' => 'App\\Controller\\SerializerController::adda'], [], [['text', '/Json/annonce/new']], [], [], []],
    'app_json_edita' => [['id'], ['_controller' => 'App\\Controller\\SerializerController::updateJsona'], [], [['text', '/edita'], ['variable', '/', '[^/]++', 'id', true], ['text', '/Json']], [], [], []],
    'app_json_deleteA' => [['id'], ['_controller' => 'App\\Controller\\SerializerController::deleteA'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/Json/annonce/delete']], [], [], []],
