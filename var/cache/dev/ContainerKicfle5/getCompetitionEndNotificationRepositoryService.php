 ...
 */
class getCompetitionEndNotificationRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CompetitionEndNotificationRepository' shared autowired service.
     *
     * @return \App\Repository\CompetitionEndNotificationRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CompetitionEndNotificationRepository.php';

        return $container->privates['App\\Repository\\CompetitionEndNotificationRepository'] = new \App\Repository\CompetitionEndNotificationRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
