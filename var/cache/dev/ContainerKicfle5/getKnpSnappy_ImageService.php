...
class getKnpSnappy_ImageService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->services['knp_snappy.image'] = $instance = new \Knp\Snappy\Image((\dirname(__DIR__, 4).'/vendor/wemersonjanuario/wkhtmltoimage-windows/bin/64bit/wkhtmltoimage'), $container->parameters['knp_snappy.image.options'], []);
