 ...
 */
class getDocumentexpeditionRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DocumentexpeditionRepository' shared autowired service.
     *
     * @return \App\Repository\DocumentexpeditionRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DocumentexpeditionRepository.php';

        return $container->privates['App\\Repository\\DocumentexpeditionRepository'] = new \App\Repository\DocumentexpeditionRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
