 ...
 */
class getColisRecRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ColisRecRepository' shared autowired service.
     *
     * @return \App\Repository\ColisRecRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ColisRecRepository.php';

        return $container->privates['App\\Repository\\ColisRecRepository'] = new \App\Repository\ColisRecRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
