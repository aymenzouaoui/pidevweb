 ...
 */
class getValidationRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ValidationRepository' shared autowired service.
     *
     * @return \App\Repository\ValidationRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ValidationRepository.php';

        return $container->privates['App\\Repository\\ValidationRepository'] = new \App\Repository\ValidationRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
