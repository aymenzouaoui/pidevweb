 ...
 */
class getReclamationsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ReclamationsRepository' shared autowired service.
     *
     * @return \App\Repository\ReclamationsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ReclamationsRepository.php';

        return $container->privates['App\\Repository\\ReclamationsRepository'] = new \App\Repository\ReclamationsRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
